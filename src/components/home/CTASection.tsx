          ...
          <Reveal delay={0.55}>
            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
              <Magnetic strength={0.4}>
                <Link
                  to="/booking"
                  className="group relative inline-flex items-center justify-center gap-2 bg-primary text-primary-foreground px-10 py-5 text-xs uppercase font-bold tracking-widest rounded-full overflow-hidden shadow-[0_0_30px_hsl(49_100%_50%/0.25)] hover:shadow-[0_0_50px_hsl(49_100%_50%/0.5)] hover:scale-105 transition-all duration-500"
                >
                  {/* Sheen sweep */}
